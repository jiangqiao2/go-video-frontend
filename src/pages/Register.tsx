  ...
  return (
    <Layout style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', background: '#0a0a0a' }}>
      ...
      <div style={{
        ...
        filter: 'blur(60px)',
        animation: 'retro-float 11s ease-in-out infinite',
        zIndex: 1,
      }} />
      ...
      <div style={{
        ...
        filter: 'blur(50px)',
        animation: 'retro-float 13s ease-in-out infinite 1.5s',
        zIndex: 1,
      }} />
      ...
      <div className={mounted ? 'fade-in typewriter' : ''} style={{
        ...
        <p style={{ margin: 0, fontSize: 12, marginTop: 4, opacity: 0.5 }}>* PRESS START TO BEGIN *</p>
      </div>
